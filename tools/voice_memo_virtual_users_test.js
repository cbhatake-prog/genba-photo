...
const fixedCases = [
  ...
  { id: 'video-count-swallowed-next-size-543-320', utterance: '543 32本 320 4本', expected: [asItem(543, 3), asItem(320, 4)] },
  { id: 'video-count-swallowed-next-size-3400-378', utterance: '3400 33本 378 3本', expected: [asItem(3400, 3), asItem(378, 3)] },
  { id: 'video-real-two-digit-count-kept-before-other-size', utterance: '543 32本 890 2本', expected: [asItem(543, 32), asItem(8900, 2)] },
  { id: 'video-noisy-speech-dropped', utterance: '400\u65e5\u672c 2420 1420\u6ce2\u7d0b \u309283\u672c 3420\u672c \u30921132 4\u672c \u30921960\u3088\u3046\u65e5\u672c \u516c\u884643 324\u672c 143', expected: [] },
  { id: 'video-noisy-single-item-dropped', utterance: '\u4eca\u98a8\u306e\u6c5a\u6c34\u69fd\u3067109 4\u672c\u3067\u51e6\u65b9\u6599\u53ce\u5165\u306f\u4e0d\u5909', expected: [] },
  ...
  { id: 'six-hundred-spaced-kept', utterance: '600 2\u672c', expected: [asItem(600, 2)] },
  { id: 'six-thousand-spaced-kept', utterance: '6000 2\u672c', expected: [asItem(6000, 2)] },
  { id: 'six-hundred-fused-ambiguous-dropped', utterance: '6002\u672c', expected: [] },
  { id: 'six-thirty-fused-ambiguous-dropped', utterance: '6304\u672c', expected: [] },
  { id: 'six-fifty-fused-ambiguous-dropped', utterance: '6503\u672c', expected: [] },
  { id: 'six-thousand-fused-kept', utterance: '60002\u672c', expected: [asItem(6000, 2)] },
  { id: 'six-thirty-hundred-fused-kept', utterance: '63004\u672c', expected: [asItem(6300, 4)] },
  { id: 'six-fifty-hundred-fused-kept', utterance: '65003\u672c', expected: [asItem(6500, 3)] },
  { id: 'six-fifty-two-digit-fused-ambiguous-dropped', utterance: '65012\u672c', expected: [] },
  { id: 'zero-dropped-2300-20-ambiguous-dropped', utterance: '2320\u672c', expected: [] },
  { id: 'zero-dropped-3400-10-ambiguous-dropped', utterance: '3410\u672c', expected: [] },
  { id: 'zero-dropped-5300-50-ambiguous-dropped', utterance: '5350\u672c', expected: [] },
  { id: 'zero-dropped-10000-50-ambiguous-dropped', utterance: '10050\u672c', expected: [] },
  { id: 'kanji-3400-10-not-3410x1', utterance: '\u4e09\u5343\u56db\u767e\u5341\u672c', expected: [asItem(3400, 10)] },
  { id: 'kanji-5300-50-not-5305x10', utterance: '\u4e94\u5343\u4e09\u767e\u4e94\u5341\u672c', expected: [asItem(5300, 50)] },
  { id: 'kanji-1200-50-not-1205x10', utterance: '\u5343\u4e8c\u767e\u4e94\u5341\u672c', expected: [asItem(1200, 50)] },
  { id: 'kanji-10000-50-not-10005x10', utterance: '\u4e00\u4e07\u4e94\u5341\u672c', expected: [asItem(10000, 50)] },
